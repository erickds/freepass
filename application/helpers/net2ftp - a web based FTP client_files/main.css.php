...
#head {
	...
	padding-bottom: 20px;
	height: 62px;
	background: url(/file-manager/skins/blue/images/img/bg_head.jpg) no-repeat;
}
...
.menuhead {
	background: url(/file-manager/skins/blue/images/img/bg_tabletop.png);
	height: 18px;
	width: 200px;
	color: #FFF;
	padding-top: 2px;
...
#tablefeature span {
	background-image: url(/file-manager/skins/blue/images/img/arrow.gif);
...
#foot {
	height: 24px;
	background: url(/file-manager/skins/blue/images/img/bg_foot.jpg) no-repeat;
	text-align: center;
	padding-top: 13px;
	color: #fff;
